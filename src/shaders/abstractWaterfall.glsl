// CC0: Abstract Waterfall
//  I saw a neat YouTube video: https://www.youtube.com/watch?v=gx7KLCC7eKY
//  Tried to make an interpretation of it.
...
vec3 stars(vec3 F, vec3 P, float A, float AA, float T) {
  ...
  ;
  F+=c.xyz*1e-5/max(dot2(vec2(dq.y/dq.x,1)*q),1e-6);
  return F;
}
